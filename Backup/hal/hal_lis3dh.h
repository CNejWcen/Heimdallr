...
#ifndef _HAL_LIS3DH_H_
#define _HAL_LIS3DH_H_
...
typedef uint8 LIS3DH_IntPinConf_t;
typedef uint8 LIS3DH_Axis_t;
typedef uint8 LIS3DH_Int1Conf_t;
...
*         /|  ___*\/                                 
*       /  |     |
*       initial status :  +X -Y +Z
*
*/    

typedef enum {                                                                  //* means the first pin label of Top Side
  LIS3DH_UP_SX                         =               0x44,                    //* in -X -Y +Z
  LIS3DH_UP_DX                         =               0x42,                    //* in +X -Y +Z
  LIS3DH_DW_SX                         =               0x41,                    //* in -X -Y -Z
  LIS3DH_DW_DX                         =               0x48,                    //* in +X -Y -Z
  LIS3DH_TOP                           =               0x60,                    //* in +X +Y +Z
  LIS3DH_BOTTOM                        =               0x50                     //* in -Z
...
status_t LIS3DH_GetClickResponse(uint8* val);
status_t LIS3DH_GetTempRaw(int8* val);
...
uint8 LIS3DH_WriteReg(uint8 Reg, uint8 Data);
