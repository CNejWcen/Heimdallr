...
#define SENSOR_SERVICE_UUID     HUMI_SERV_UUID
...
static gattAttribute_t sensorAttrTable[11] =
{
  {
 ...
 */
bStatus_t Humi_AddService( uint32 services )
{
 ...
 */
bStatus_t Humi_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
...
bStatus_t Humi_AsmParameter(uint8 param, uint8 *buf,void *value)
{
    bStatus_t ret = SUCCESS;
    switch ( param )
    {
        case SENSOR_DATA:
          VOID osal_memcpy( buf, value, SENSOR_DATA_LEN );
          break;
    }
    return ret;
}
 ...
 * @return  bStatus_t
 */
bStatus_t Humi_SetParameter( uint8 param, uint8 len, void *value )
{
  bStatus_t ret = SUCCESS;
 ...
 * @return  bStatus_t
 */
bStatus_t Humi_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
