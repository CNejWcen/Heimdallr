...
#define ACCEL_XYZ_ATTR                0x01  // RW int16 - Profile Attribute value
#define ACCEL_6D_ATTR                 0x02  // RW int16 - Profile Attribute value
#define ACCEL_CLICK_ATTR              3  // RW int16 - Profile Attribute value
#define ACCEL_RANGE                   4  // RW uint16 - Profile Attribute value
  
// Profile UUIDs
#define ACCEL_ENABLER_UUID            0xFFA1
#define ACCEL_RANGE_UUID              0xFFA2
#define ACCEL_XYZ_UUID                0xFFA3
#define ACCEL_6D_UUID                 0xFFA4
#define ACCEL_CLICK_UUID              0xFFA5
  
// Accelerometer Service UUID
#define ACCEL_SERV_UUID            0xFFA0
...
extern bStatus_t Accel_AsmParameter(uint8 param, uint8 *buf,void *value);
/*
